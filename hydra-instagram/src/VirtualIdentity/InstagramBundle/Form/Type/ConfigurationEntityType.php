...
namespace VirtualIdentity\InstagramBundle\Form\Type;
...
class ConfigurationEntityType extends AbstractType
{
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            ->add('consumerSecret', 'text', array('label' => 'Client Secret'))
    ...
    public function setDefaultOptions(OptionsResolverInterface $resolver)
    {
        $resolver->setDefaults(array(
            'data_class' => 'VirtualIdentity\InstagramBundle\Form\ConfigurationEntity',
        ));
    }
